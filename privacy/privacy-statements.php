    ...
    <p>
        The Team of MTL Brains  called MTL Team built the Quiz of General Knowledge 2021 - Free game app as
        a Free app. This SERVICE is provided by MTL Team at no cost and is intended for use as is.
    </p> 
    ...
    <p>
        ...
        policy. The Personal Information that we collect is used for providing and improving the Service. 
    ...
    <p>
        The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible
         at Quiz of General Knowledge 2021 - Free game unless otherwise defined in this Privacy Policy.
    </p> 
    ...
    <p>
        ...
        identifiable information. For example, we will store your progress in the cloud, which will be associated 
        with your device is and/or with your play services nickname, to restore your progres upon application 
        reinstall. Except this, the information that I request will be retained on your device and is not collected by us in any way.
    </p> 
    ...
    <p>
        ...
        we collect data and information (through third party products) on your phone called Log Data. This Log Data may
        include information such as your device Internet Protocol (“IP”) address, device name, operating system version, the
    ...
    <p>
        ...
        You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you
    ...
    <p>
        ...
        that these third parties have access to your Personal Information. The reason is to perform the tasks assigned to
    ...
    <p>
        ...
        We do not knowingly collect personally identifiable information from children under 13. In the case
    ...
    <p>
        ...
        time to time. Thus, you are advised to review this page periodically for any changes. We will
        notify you of any changes by posting the new Privacy Policy on this page.
    </p> 
    
    <p>This policy is effective as of 2020-12-06</p> 
    
    <p><strong>Contact Us</strong></p> 
    <p>
        If you have any questions or suggestions about our
        Privacy Policy, do not hesitate to contact us at mtlteam.contact@gmail.com.
    </p>